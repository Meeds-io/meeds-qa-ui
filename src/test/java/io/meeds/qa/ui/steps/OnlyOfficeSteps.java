...
import io.meeds.qa.ui.pages.OnlyOfficePage;

public class OnlyOfficeSteps {

  private OnlyOfficePage onlyOfficePage;

  public void attachFileToActivity(String fileName) {
    onlyOfficePage.attachFileToActivity(fileName);
  }
