...
public class UserProfileStepDefinition {
	...
	@When("I open the chat from the user's profile")
	public void openChatDrawer() {
		userProfileSteps.openChatDrawer();
	}
	...
	public void checkListOfItem(List<String> listOfItems) {
		assertThat(userProfileSteps.checkListOfFields(listOfItems))
				.as(String.format("The item %s is not diplayed", userProfileSteps.checkListOfFields(listOfItems)))
				.isEmpty();
	}
	...
	public void checkMyPointIncrease() {
		...
		assertThat(userProfileSteps.wasMyPointIncreased(myPointBeforeKudos))
				.as("The point did not increase after send kudos").isTrue();
	}
	...
	public void isProfileContactRandomUrlVisible() {
		String url = "community-preprod.exoplatform.com/portal/dw/profile/khalil_riahi";
	...
	public void updateBasicInformationTribe(Map<String, String> basicInformations) {
		userProfileSteps.updateBasicInformationTribe(basicInformations);
	}
	...
	public void updateContactOtherInformationsTribe(Map<String, String> basicInformations) {
		userProfileSteps.updateContactOtherInformationsTribe(basicInformations);
	}
	...
	public void updateRandomBasicInformationTribe() {
		...
		{
			{
				...
				String url = "https://community-preprod.exoplatform.com/portal/dw/profile/khalil_riahi";
