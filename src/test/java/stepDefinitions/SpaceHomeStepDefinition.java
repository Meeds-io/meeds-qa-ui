...
public class SpaceHomeStepDefinition {
    ...
    @Then("^The file title '(.*)' is displayed$")
    public void checkPreviewAttachedFile(String file) {
        spaceHomeSteps.checkPreviewFile(file);
    }

    @Then("^The file extension '(.*)' is displayed$")
    public void checkPreviewFileExtension(String fileExtension) {
        spaceHomeSteps.checkPreviewFileExtension(fileExtension);
    }
    ...
    @When("^I select the existing folder$")
    public void selectFolder() {
        spaceHomeSteps.selectFolder();
    }

    @When("^I create a new folder '(.*)'$")
    public void createFolder(String folderTitle) {
        spaceHomeSteps.createFolder(folderTitle);
    }

    @When("^Delete and Edit Folder Buttons are displayed$")
    public void checkThatDeleteAndEditFolderButtonsAreDisplayed() {
        spaceHomeSteps.checkThatDeleteAndEditFolderButtonsAreDisplayed();
    }

    @When("^I delete the folder$")
    public void deleteFolder() {
        spaceHomeSteps.deleteFolder();
    }
    ...
    public void checkThatFolderIsDeleted(String folderName) {
        spaceHomeSteps.checkThatFolderIsDeleted(folderName);
    }
    ...
    @When("^the link 'write an article' is displayed in the drawer$")
    ...
    @When("^As a simple user i click on 'write an article'$")
    public void clickwriteArticleLinkSimpleUser() {
        spaceHomeSteps.clickwriteArticleLinkSimpleUser();
    }
    ...
    @Then("I click on the title of the article in the activity stream")
    public void clickArticleTitle() {
        spaceHomeSteps.clickArticleTitle();
    }

    @Then("The article with summary '(.*)' and title '(.*)' is archived and not clickable in the activity stream")
    public void archivedArticleNotClickableInActivityStream(String summary, String title) {
        spaceHomeSteps.archivedArticleNotClickableInActivityStream(summary, title);
    }

    @When("the article is displayed with the image added in the activity stream of the space")
    public void checkArticleWithImage() {
        assertThat(spaceHomeSteps.checkArticleWithImage()).as("l'article n'est pas ajouté").isEmpty();
    }

    @Then("I click on 'read more' of the article in the activity stream")
    ...
    public void enterCommentLink(String activity, String link) {
        ...
        spaceHomePage.enterCommentLink(spaceHomePage.getActivityIdDW(activity), link);
    }
    ...
    public void createPollDrawerClosed() { spaceHomeSteps.createPollDrawerClosed(); }
    ...
    public void clickOnCommentActivity(String activity) {
        spaceHomePage.getActivityIdDW(activity);
        spaceHomePage.clickOnCommentActivityButton(spaceHomePage.getActivityIdDW(activity));
    }
    ...
    @Then("The updated article is displayed in the activity stream of the space")
    public void checkUpdatedArticleVisible() {
        assertThat(spaceHomeSteps.checkUpdatedArticleDetails()).as("The article details should be displayed but it is not")
                .isEmpty();
    }
    ...
    @Then("the file '(.*)' is displayed in the activity stream")
    ...
    @Then("The file '(.*)' is not displayed in the activity stream")
    public void checkFileNotDisplayd(String fileName) {
        Serenity.getWebdriverManager().getCurrentDriver().navigate().refresh();
        assertThat(spaceHomeSteps.isUploadedFileNotDisplayed(fileName)).as("Uploaded file should be not displayed")
                .isTrue();
    }
    ...
    @Then("The image '(.*)' is displayed in the activity stream")
    public void checkImageShared(String fileName) {
        assertThat(spaceHomeSteps.isSharedImageVisible(fileName)).as("shared image should be displayed but it is not")
                .isTrue();
    }
    ...
    @When("^I delete the file '(.*)' in Documents Tab$")
    public void deleteFileInDocumentsTab(String uploadedFileName) {
        spaceHomeSteps.deleteFileInDocumentsTab(uploadedFileName);
    }
    ...
    @When("^File '(.*)' is not displayed in Documents Tab$")
    public void fileIsNotDisplayedInDocumentsTab(String uploadedFileName) {
        spaceHomeSteps.fileIsNotDisplayedInDocumentsTab(uploadedFileName);
    }

    @Then("^I select the existing file '(.*)'$")
    ...
    @When("^I click on spacename '(.*)' in activity loader$")
    public void clickSpace(String spanceName) {
        spaceHomeSteps.clickSpace(spanceName);
    }

    @When("^I open select from drive drawer$")
    public void clickSelectFromDrive() {
        spaceHomeSteps.clickSelectFromDrive();
    }

    @When("^I select from drives$")
    public void selectFromDrives() {
        spaceHomeSteps.selectFromDrives();
    }

    @When("^I click on current space as drive$")
    public void clickOnCurrentSpaceAsDrive() {
        spaceHomeSteps.clickOnCurrentSpaceAsDrive();
    }

    @When("^I create a new folder '(.*)' in Documents Tab$")
    public void createFolderInDocumentsTab(String folderTitle) {
        spaceHomeSteps.createFolderInDocumentsTab(folderTitle);
    }

    @When("^The created folder '(.*)' is displayed$")
    public void checkThatFolderIsDisplayed(String folderName) {
        spaceHomeSteps.checkThatFolderIsDisplayed(folderName);
    }

    @When("^I open the folder '(.*)' in Documents Tab$")
    public void openFolderInDocumentsTab(String folderTitle) {
        spaceHomeSteps.openFolderInDocumentsTab(folderTitle);
    }

    @Then("^Add from drive button is displayed$")
    public void checkSelectFromDriveIcon() {
        assertThat(spaceHomeSteps.isSelectFromDrivesButtonVisible())
                .as("select from drive button should be displayed but it is not").isTrue();
    }

    @Then("^I click on Add from drive button$")
    public void clickAddDrive() {
        spaceHomeSteps.clickAddDrive();
    }

    @Then("^Google Drive Button is displayed in Connect your service drawer$")
    ...
    @Then("^One Drive Button is displayed in Connect your service drawer$")
    ...
    @Then("^I select the file '(.*)' from the drive '(.*)'$")
    public void selectDrive(String fileName, String drive) {
        spaceHomeSteps.selectDrive(drive, fileName);
    }

    @Then("^I select the file '(.*)' from the first drive$")
    public void selectFirstDrive(String fileName) {
        String drive = Serenity.sessionVariableCalled("randomSpaceName");
        spaceHomeSteps.selectDrive(drive, fileName);
    }
    ...
    public void addActivityComment(String activity, String comment) {
        spaceHomePage.getActivityIdDW(activity);
        spaceHomePage.addActivityComment(spaceHomePage.getActivityIdDW(activity), comment);
    }
    ...
    public void addInternalLinkComment(String activity, String comment) {
        String currentUrl = Serenity.getWebdriverManager().getCurrentDriver().getCurrentUrl().split("portal")[0];
        spaceHomePage.getActivityIdDW(activity);
        spaceHomePage.addActivityComment(spaceHomePage.getActivityIdDW(activity), currentUrl + comment);
    }

    @When("^I add a reply '(.*)' to comment '(.*)' in activity '(.*)'$")
    public void addCommentReply(String reply, String comment, String activity) {
        spaceHomePage.getActivityIdDW(activity);
        spaceHomePage.addCommentReply(reply, comment, spaceHomePage.getActivityIdDW(activity));
    }
    ...
    public void openCommentsDrawer(String activity) {
        spaceHomePage.getActivityIdDW(activity);
        spaceHomePage.openCommentsDrawer(spaceHomePage.getActivityIdDW(activity));
    }

    @When("^I unpin the activity stream article '(.*)'$")
    public void unpinArticle(String activity) {
        spaceHomePage.getNewsArticleActivityIdDW(activity);
        spaceHomePage.unpinArticle(spaceHomePage.getNewsArticleActivityIdDW(activity));
    }
    ...
    public void CheckActivityIsNotVisible(String activity) {
        assertThat(spaceHomeSteps.isActivityVisible(activity))
                .as("Activity is displayed in activity stream").isFalse();
    }
    ...
    @And("^I check that Share article button is displayed")
    public void checkShareArticleButtonStream() {
        spaceHomeSteps.checkShareArticleButtonStream();
    }
    ...
    @When("I access to the news details page from the article '(.*)'")
    public void accessNewsDetails(String articleName) {
        spaceHomeSteps.accessNewsDetails(articleName);
    }
    ...
    public void clickOnTheKudosButtonFromTheActivityStream() { spaceHomeSteps.clickKudosFromActivityStream(); }

    @Then("I check that the article is shared in the stream of the space")
    public void checkArticleSharedInSpace() {
        String description = Serenity.sessionVariableCalled("articledescription");
        spaceHomeSteps.checkArticleSharedInSpace(description);
    }
