...
import steps.AdminApplicationSteps;
...
public class AdminApplicationStepDefinition {
	...
	public void enterRandomApplicationTitleUrlDescriptionWithImage(String image) {
		...
		adminApplicationSteps.enterRandomApplicationTitleUrlDescriptionImage(randomApplicationTitle, randomApplicationUrl, randomApplicationDescription, image);
	...
	public void enterRandomApplicationTitleUrlDescription() {
		...
		adminApplicationSteps.enterRandomApplicationTitleUrlDescription(randomApplicationTitle, randomApplicationUrl, randomApplicationDescription);
	...
	public void enterSecondRandomApplicationTitleUrlDescriptionWithImage(String image) {
		...
		adminApplicationSteps.enterRandomApplicationTitleUrlDescriptionImage(secondRandomApplicationTitle, secondRandomApplicationUrl, secondRandomApplicationDescription, image);
	...
	public void editRandomApplicationTitleUrlDescription() {
		...
		adminApplicationSteps.editRandomApplicationTitleUrlDescription(randomApplicationTitle, editedRandomApplicationTitle, editedRandomApplicationUrl, editedRandomApplicationDescription);
	}

	@When("Edit Agenda title is displayed '(.*)' in drawer")
	...
	@When("Edit Agenda permissions '(.*)' and '(.*)' are displayed in drawer")
