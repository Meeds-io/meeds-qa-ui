...
public class AddUserStepDefinition {
	...
	@Given("^I delete user$")
	public void deleteUser() { addUserSteps.deleteUser(); }
	...
	public void clickToDeleteUser() { addUserSteps.clickToDeleteUser(); }

	@Given("^Popup is displayed to inform user that we can't delete your user account while being logged in with it$")
	public void checkPopupCantDeleteLoggedUser() { addUserSteps.checkPopupCantDeleteLoggedUser(); }
