...
public class ManageUnifiedSearchStepDefinitions {
    ...
    public void searchInTribe(String element) {
        manageUnifiedSearchSteps.searchInTribe(element);
    }
    ...
    public void searchForFirstRandomCreatedSpace() {
        ...
        manageUnifiedSearchSteps.searchInTribe(randomSpaceName);
    }
    ...
    @Then("^The attached file is displayed in the search '(.*)'$")
    public void isSearchedAttachedFileVisible(String attachedFile) {
        manageUnifiedSearchSteps.isSearchedAttachedFileVisible(attachedFile);
    }
    ...
    @Then("^I click on the searched task '(.*)'$")
    @When("^I click on the file '(.*)'$")
    public void goToTheSearchedFile(String file) {
        manageUnifiedSearchSteps.goToTheSearchedFile(file);
    }
