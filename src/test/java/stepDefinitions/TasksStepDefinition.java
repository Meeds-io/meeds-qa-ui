...
import steps.TasksSteps;

import java.util.Map;

import static org.assertj.core.api.Assertions.assertThat;
import static stepDefinitions.ManageSpaceStepDefinitions.getRandomNumber;
...
public class TasksStepDefinition {
    ...
    @And("^I attach the file '(.*)' in the Upload Document drawer$")
    public void attachDocument(String fileName) throws InterruptedException {
        tasksSteps.attachDocument(fileName);
    }
    ...
    @And("^The uploaded file '(.*)' is displayed in attachment section$")
    public void checkFileDisplay(String fileName) {
        tasksSteps.checkFileDisplay(fileName);
    }
    ...
    @And("^I open the uploaded file '(.*)' in full screen$")
    public void openFileUploaded(String fileName) {
        tasksSteps.openFileUploaded(fileName);
    }

    @And("^I click on Edit option from the full screen$")
    public void editFile() {
        tasksSteps.editFile();
    }

    @Then("^The uploaded file '(.*)' should be opened in onlyoffice with the user '(.*)'$")
    public void checkOOEditor(String titleDoc, String userName) throws InterruptedException {
        switchToTabByIndex(1);
        tasksSteps.checkOpeningFileWithEditOnline(titleDoc, userName);
    }

    @Then("^The uploaded file '(.*)' should be opened in onlyoffice with the first user$")
    public void checkOOEditorWithFirstUser(String titleDoc) throws InterruptedException {
        switchToTabByIndex(1);
        String firstUserFirstName = Serenity.sessionVariableCalled("firstUserFirstName");
        String firstUserLastName = Serenity.sessionVariableCalled("firstUserLastName");

        String fullName = firstUserFirstName + " " + firstUserLastName;
        tasksSteps.checkOpeningFileWithEditOnline(titleDoc, fullName);
    }
    ...
    @And("^I detach the uploaded file from the attachment list$")
    public void detachAttachment() {
        tasksSteps.detachAttachment();
    }

    @And("^The detached file '(.*)' is not displayed in attachment list$")
    public void checkAttachmentDisplay(String attachmentName) {
        tasksSteps.checkAttachmentDisplay(attachmentName);
    }
    ...
    @And("^The detached file '(.*)' is not displayed in the attachment section$")
    public void verifyAttachmentDisplay(String attachmentName) {
        tasksSteps.verifyAttachmentDisplay(attachmentName);
    }
    ...
    @When("^I click to change the file location$")
    public void clickChangeLocation() {
        tasksSteps.clickChangeLocation();
    }
    ...
    @Then("^The changed file '(.*)' is displayed in the documents application$")
    public void checkChangedFile(String changedFileName) {
        tasksSteps.checkChangedFile(changedFileName);
    }
    ...
    @Then("^The changed file '(.*)' should be displayed in the new drive selected$")
    public void checkMovedFile(String movedFileName) {
        tasksSteps.checkMovedFile(movedFileName);
    }
    ...
    public void hoverOnProjectManagerIcon(){tasksSteps.hoverOnProjectManagerIcon();}
}
