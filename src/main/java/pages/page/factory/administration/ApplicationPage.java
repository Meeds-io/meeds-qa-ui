...
public class ApplicationPage extends GenericPage {
	...
	@FindBy(xpath = "//td[contains(text(),'Agenda')]/..//button[contains(@data-original-title,'Edit')]")
	private BaseElementFacade editAgendaAppButton;
	...
	@FindBy(xpath = "//*[@class='appLauncherDrawerTitle' and text()='Edit application']/following::*[@for='permissions']/following::*[@class='item' and contains(text(),'/platform/users')]")
	private TextBoxElementFacade editApplicationDrawerPermissionsUsers;

	@FindBy(xpath = "//*[@class='appLauncherDrawerTitle' and text()='Edit application']/following::*[@for='permissions']/following::*[@class='item' and contains(text(),'/platform/externals')]")
	private BaseElementFacade editApplicationDrawerPermissionsExternals;

	@FindBy(xpath = "(//*[@class='appLauncherDrawerTitle' and text()='Edit application']/following::*[@class='row applicationProperties']//input[@aria-checked='true'])[1]")
	private TextBoxElementFacade editApplicationDrawerMandatoryEnabled;

	@FindBy(xpath = "(//*[@class='appLauncherDrawerTitle' and text()='Edit application']/following::*[@class='row applicationProperties']//input[@aria-checked='true'])[2]")
	private TextBoxElementFacade editApplicationDrawerActiveEnabled;

	@FindBy(xpath = "(//*[@class='appLauncherDrawerTitle' and text()='Edit application']/following::*[@class='row applicationProperties']//input[@aria-checked='true'])[3]")
	...
	private BaseElementFacade appPermissionInApplicationsTable(String appTitle, String permission) {
		return findByXpath(String.format("//td[contains(text(),'%s')]/following::*[contains(@class,'permission')][1]//span[contains(text(),'%s')]", appTitle, permission));
	}
	...
	private BaseElementFacade appImageInApplicationsTableIsNotDisplayed(String appTitle) {
		return findByXpath(String.format("(//td[contains(@class,'tableAppTitle') and contains(text(),'%s')])[1]/preceding::*[contains(@src,'/app-center/skin/images/defaultApp.png')][1]", appTitle));
	}

	private BaseElementFacade getMandatoryApplication(String appTitle) {
		return findByXpath(String.format("//*[@class='text-md-center tableAppTitle' and contains(text(),'%s')]/following::*[@class='v-input--selection-controls__input'][1]", appTitle));
	}

	private BaseElementFacade getActiveApplication(String appTitle) {
		return findByXpath(String.format("//*[@class='text-md-center tableAppTitle' and contains(text(),'%s')]/following::*[@class='v-input--selection-controls__input'][2]", appTitle));
	}
	...
	Map<String, BaseElementFacade> MAPPING_FIELD_Name_TO_BASEELEMENTFACADE_XPATH = new HashMap<String, BaseElementFacade>() {
		{
			put("Agenda", editAgendaAppButton);
		}
	};

	Map<String, TextBoxElementFacade> MAPPING_FIELD_Name_TO_TEXTBOXELEMENTFACADE_XPATH = new HashMap<String, TextBoxElementFacade>() {
		{
			put("Application title", titleAppInput);
			put("Application url", urlAppInput);
		}
	};

	Map<String, TextBoxElementFacade> MAPPING_Application_FIELD_Name_TO_TEXTBOXELEMENTFACADE_XPATH = new HashMap<String, TextBoxElementFacade>() {
		{
			put("Application title", titleAppInput);
			put("Application url", urlAppInput);
			put("Application description", applicationDescription);
		}
	};
