...
public class AddGroupsPage extends GenericPage {
	...
	public BaseElementFacade groupOpenBtn(String group) {
		return findByXpath(String
				.format("//*[@class='flex sm12 md4 flat']//*[@class='v-list-item__content']//*[contains(text(),'%s')]/preceding::i[@class='v-icon notranslate mdi mdi-menu-right theme--light'][1]", group));
	}

	public BaseElementFacade groupToSelect(String group) {
		return findByXpath(String
				.format("//*[@class='flex sm12 md4 flat']//*[@class='v-list-item__content']//*[contains(text(),'%s')]", group));
	}
