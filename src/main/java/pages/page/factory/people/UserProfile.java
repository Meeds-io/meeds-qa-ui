...
public class UserProfile extends GenericPage {
	...
	@FindBy(xpath = "//i[contains(@class,'uiIconBannerChat')]")
	private BaseElementFacade openChatButton;
	...
	private BaseElementFacade getJobTitleWorkExperience(String jobTitle) {
		return findByXpath(String.format("//*[@class='v-timeline-item__body']//*[@class='text-color' and contains(text(),'%s')]", jobTitle));
	}

	private BaseElementFacade getOrganizationWorkExperience(String organization) {
		return findByXpath(String.format("//*[@class='v-timeline-item__body']//*[@class='text-sub-title' and contains(text(),'%s')]", organization));
	}

	private BaseElementFacade getJobDetailsWorkExperience(String jobDetails) {
		return findByXpath(String.format("//*[@class='v-timeline-item__body']//*[contains(@class,'font-weight-light') and contains(text(),'%s')]", jobDetails));
	}

	private BaseElementFacade getUsedSkillsWorkExperience(String UsedSkill) {
		return findByXpath(String.format("//*[@class='v-timeline-item__body']//*[contains(@class,'font-weight-bold') and contains(text(),'%s')]", UsedSkill));
	}

	private BaseElementFacade getReceivedKudosNumber(String kudosNumber) {
		return findByXpath(String.format("//*[@id='kudosOverviewCardsParent']//*[contains(@class,'kudosReceivedOverviewPeriod')]//*[contains(@class,'kudosOverviewCount') and contains(text(),'%s')]", kudosNumber));
	}

	private BaseElementFacade getSentKudosNumber(String kudosNumber) {
		return findByXpath(String.format("//*[@id='kudosOverviewCardsParent']//*[contains(@class,'kudosSentOverviewPeriod')]//*[contains(@class,'kudosOverviewCount') and contains(text(),'%s')]", kudosNumber));
	}

	private BaseElementFacade getSentKudosUsers(String user) {
		return findByXpath(String.format("//*[contains(@class,'kudosOverviewDrawer')]//*[contains(@class,'drawerTitle') and contains(text(),'Kudos Sent')]/following::*[contains(@id,'avatar') and contains(text(),'%s')]", user));
	}

	private BaseElementFacade getReceivedKudosUsers(String user) {
		return findByXpath(String.format("//*[contains(@class,'kudosOverviewDrawer')]//*[contains(@class,'drawerTitle') and contains(text(),'Kudos Received')]/following::*[contains(@id,'avatar') and contains(text(),'%s')]", user));
	}
	...
	public void openChatDrawer() {
		openChatButton.clickOnElement();
	}

	public void updateContactOtherInformationsTribe(String company, String phoneType, String phone, String instantMessagingType, String instantMessaging, String url) {
	...
	public void updateWorkExperiences(String organization, String jobTitle, String jobDetails, String usedSkills) throws InterruptedException {
	...
	public void uploadProfileAvatar(String fileName) {
		...
		WebElement elem = getDriver().findElement(By.xpath("//*[contains(@class,'changeAvatarButton')]//*[@class='v-input__prepend-outer']//button/following::input[1]"));
