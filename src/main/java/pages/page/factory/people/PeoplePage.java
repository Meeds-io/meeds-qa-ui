...
public class PeoplePage extends GenericPage {
	...
	public TextBoxElementFacade ELEMENT_PEOPLE_SHOWING_RESULTS_DW;

	@FindBy(xpath = "//*[@id='usersLeaderboard']//*[@class='d-inline-block']")
	public TextBoxElementFacade ELEMENT_LEADER_BOARD_TITLE_DW;
	...
	public TextBoxElementFacade ELEMENT_FIRST_USER_LEADER_BOARD_POSITION_DW;

	@FindBy(xpath = "(//*[@class='v-list-item__title']//a)[2]")
	public TextBoxElementFacade ELEMENT_SECOND_USER_LEADER_BOARD_POSITION_DW;

	@FindBy(xpath = "(//*[@class='v-list-item__title']//a/following::*[@class='v-list-item__action me-4'])[1]")
	public TextBoxElementFacade ELEMENT_FIRST_USER_LEADER_BOARD_POINTS_DW;

	@FindBy(xpath = "(//*[@class='v-list-item__title']//a/following::*[@class='v-list-item__action me-4'])[2]")
	public TextBoxElementFacade ELEMENT_SECOND_USER_LEADER_BOARD_POINTS_DW;

	@FindBy(xpath = "//*[@class='v-avatar tertiary']")
	public TextBoxElementFacade ELEMENT_CURRENT_USER_LEADER_BOARD_POSITION_DW;

	@FindBy(xpath = "(//*[@class='v-input__prepend-inner']/following::*[@class='v-text-field__slot']/input/following::select)[1]")
	public TextBoxElementFacade ELEMENT_PEOPLE_PULLDOWN_FILTER_DW;
	...
	public BaseElementFacade ELEMENT_FIRST_SUGGESTION_DW;

	@FindBy(xpath = "(//*[@class='v-list-item__content pb-3']//a)[2]")
	public BaseElementFacade ELEMENT_SECOND_SUGGESTION_DW;

	@FindBy(xpath = "//*[@class='peopleOverviewCard d-flex flex-column clickable']")
	public BaseElementFacade ELEMENT_SENT_REQUESTS_BTN_DW;
	...
	public BaseElementFacade ELEMENT_CLOSE_SENT_REQUESTS_BTN_DW;

	@FindBy(xpath = "(//*[@class='uiIconInviteUser'])[1]")
	public BaseElementFacade ELEMENT_ADD_FIRST_USER_SUGGESTION_DW;

	@FindBy(xpath = "(//*[@class='uiIconInviteUser'])[2]")
	public BaseElementFacade ELEMENT_ADD_SECOND_USER_SUGGESTION_DW;

	@FindBy(xpath = "(//*[@class='uiIconCloseCircled'])[1]")
	public BaseElementFacade ELEMENT_DELETE_FIRST_SUGGESTION_DW;

	@FindBy(xpath = "(//*[@class='uiIconCloseCircled'])[2]")
	public BaseElementFacade ELEMENT_DELETE_SECOND_SUGGESTION_DW;
	...
	@FindBy(xpath = "//*[contains(@class,'drawerParent chatDrawer')]//*[contains(@class,'mdi mdi-close')]")
	public BaseElementFacade closeChatDrawer;
	...
	private BaseElementFacade getDisconnectUserButton(String user) {
		return findByXpath(String.format(
				"//a[contains(@href,'%s')]//following::i[contains(@class,'uiIconSocCancelConnectUser')]", user));
	}

	public BaseElementFacade ELEMENT_CURRENT_USER_LEADER_BOARD_POINTS_DW(String id) {
		return findByXpath(String
				.format("(//*[@class='v-list-item__title']//a/following::*[@class='v-list-item__action me-4'])['%s']", id));
	}

	public BaseElementFacade ELEMENT_SENT_REQUESTS_USERS_DW(String user) {
		return findByXpath(String
				.format("//*[@class='layout column']//*[@class='v-list-item__title']//a[contains(text(),'%s')]", user));
	}

	public BaseElementFacade ELEMENT_ADD_CONTACT_FULLNAM_WITH_PARAM_DW(String user) {
		return findByXpath(String
				.format("//*[@class='v-card__text peopleCardBody align-center pt-2 pb-1']//a[contains(text(),'%s')]", user));
	}

	public BaseElementFacade ELEMENT_DELETE_SENT_REQUESTS_USERS_DW(String user) {
		return findByXpath(String
				.format("//*[@class='layout column']//*[@class='v-list-item__title']//a[contains(text(),'%s')]/following::button[1]", user));
	}
	...
	private BaseElementFacade getChatButton(String user) {
		return findByXpath(
				String.format("//a[contains(@href,'%s')]/../..//i[contains(@class,'uiIconBannerChat')]", user));
	}
	...
	public void closeChatDrawer() {
		closeChatDrawer.clickOnElement();
	}
	...
	public void openChatDrawer(String user) {
		searchPeopleInput.setTextValue(user);
		getUserMenu(user).clickOnElement();
		getChatButton(user).clickOnElement();
	}
}
