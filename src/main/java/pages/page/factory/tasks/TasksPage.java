...
public class TasksPage extends GenericPage {
  ...
  private BaseElementFacade getChangedFileName(String changedFileName) {
    return findByXpath(
                       String.format("//a[@class='actionLabel']/span[@class='nodeName' and contains(text(),'%s')]",
                                     changedFileName));
  }
  ...
  public void attachDocument(String fileName)
    ...
    Thread.sleep(3000);
    WebElement elem =
                    getDriver().findElement(By.xpath("//div[@class='multiUploadFilesSelector d-flex flex-column']//input[@name='file']"));
