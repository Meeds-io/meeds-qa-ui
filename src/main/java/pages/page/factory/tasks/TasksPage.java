...
public class TasksPage extends GenericPage {
    ...
    @FindBy(xpath = "//*[@class='v-alert v-sheet theme--dark success']//*[@class='v-alert__content' and contains(text(),'Project successfully created')]")
    ...
    @FindBy(xpath = "//*[@class='v-alert v-sheet theme--dark success']//*[@class='v-alert__content' and contains(text(),'Project successfully deleted')]")
    private TextBoxElementFacade alertMessageAfterProjectDeletion;

    @FindBy(xpath = "//*[@class='v-alert v-sheet theme--dark success']//*[@class='v-alert__content' and contains(text(),'Project successfully updated')]")
    ...
    @FindBy(xpath = "//*[@class='v-alert v-sheet theme--dark success']//*[@class='v-alert__content' and contains(text(),'Project successfully cloned')]")
    private TextBoxElementFacade alertMessageAfterProjectClone;

    @FindBy(xpath = "//*[@class='v-alert v-sheet theme--dark success']//*[@class='v-alert__content' and contains(text(),'Status successfully deleted')]")
    private TextBoxElementFacade alertMessageAfterStatusDeletion;

    @FindBy(xpath = "//*[@class='v-alert v-sheet theme--dark success']//*[@class='v-alert__content' and contains(text(),'Status successfully moved')]")
    private TextBoxElementFacade alertMessageAfterStatusMoved;

    @FindBy(xpath = "//*[@class='v-alert v-sheet theme--dark success']//*[@class='v-alert__content' and contains(text(),'Task successfully deleted')] ")
    ...
    private BaseElementFacade getTaskStatusColumn(String status) {
        return findByXpath(String.format("(//*[contains(@class,'taskStatusName')]//*[@title='%s']/following::*[@class='taskTitleEllipsis'])[1]", status));
    }
    ...
    private BaseElementFacade getMovedFile(String movedFileName) {
        return findByXpath(
                String.format("//span[@class='nodeName' and contains(text(),'%s')]", movedFileName));
    }

    private BaseElementFacade selectDriveName(String driveName) {
        return findByXpath(
                String.format("//div[@class='rowDrives rowDrivesGroups clearfix']//a[@data-original-title='%s']", driveName));
    }

    private BaseElementFacade getOthersDriveTitle(String othersDriveTitle) {
        return findByXpath(
                String.format("(//div[@class='selectionBox px-5 d-flex flex-wrap'])[3]//div[@title='%s']", othersDriveTitle));
    }

    private BaseElementFacade getTaskCommentReplyBtn(String comment) {
        return findByXpath(
                String.format("//*[contains(@class,'taskCommentDrawer')]//*[@class='taskContentComment']/p[contains(text(),'%s')]/following::button[@id='reply_btn'][1]", comment));
    }

    private BaseElementFacade getChangedFileName(String changedFileName) {
        return findByXpath(
                String.format("//a[@class='actionLabel']/span[@class='nodeName' and contains(text(),'%s')]", changedFileName));
    }
    ...
    private BaseElementFacade getSpaceDriveTitle(String spaceDriveTitle) {
        return findByXpath(
                String.format("(//div[@class='selectionBox px-5 d-flex flex-wrap'])[2]//div[@title='%s']", spaceDriveTitle));
    }
    ...
    @FindBy(xpath = "(//*[contains(@class,'profile-popover')]//a[contains(@id,'userAvatar')]/following::div[contains(@class,'ms-2')])[2]")
    ...
    @FindBy(xpath = "//div[@class='attachmentsList']//a[@class='viewAllAttachments primary--text font-weight-bold text-decoration-underline']")
    ...
    @FindBy(xpath = "//*[@class='v-alert v-sheet theme--dark success']//*[@class='v-alert__content' and contains(text(),'Task successfully marked as completed')]")
    ...
    private BaseElementFacade getFileName(String fileName) {
        return findByXpath(
                String.format("//div[@class='v-list v-sheet theme--light v-list--dense']//div[@title='%s']", fileName));
    }
    ...
    private BaseElementFacade getProjectParticipant(String fullName) {
        return findByXpath(
                String.format("//div[contains(@class,'identitySuggestionMenuItemText') and contains(text(),'%s')]", fullName));
    }
    ...
    private BaseElementFacade projectNameInProjectDetails(String projectName) {
        return findByXpath(String.format("//*[@id='projectListApplication']//*[contains(@class,'taskViewBreadcrumb')]//span[contains(text(),'%s')]", projectName));
    }

    private BaseElementFacade taskNameInProjectDetails(String taskName) {
        return findByXpath(String.format("//*[contains(@class,'taskStatusName')]//*[@title='To Do']/following::*[@class='taskTitleEllipsis' and contains(text(),'%s')]", taskName));
    }

    private BaseElementFacade getLabelInEditProjectDrawer(String label) {
        return findByXpath(
                String.format("//*[contains(@class,'v-chip__content')]//*[contains(@class,'pr-2') and contains(text(),'%s')]", label));
    }

    private BaseElementFacade getCompletedTask(String taskName) {
        return findByXpath(String.format("//*[@class='nameGroup' and text()='Archived']//following::*[@class='taskCardViewTitle text-color strikethrough']//span[@class='taskTitleEllipsis' and contains(text(),'%s')]", taskName));
    }

    private BaseElementFacade getUncompletedTask(String taskName) {
        return findByXpath(String.format("//*[@class='nameGroup' and text()='Uncompleted']//following::*[@class='taskCardViewTitle text-color']//span[@class='taskTitleEllipsis' and contains(text(),'%s')]", taskName));
    }

    private BaseElementFacade getTasksNumberToDo(String tasksNumber) {
        return findByXpath(String.format("//*[contains(@class,'taskStatusName')]//*[@title='To Do']/following ::*[@class='uiTaskNumber' and text()='%s']", tasksNumber));
    }


    private BaseElementFacade taskNameAndLabelAndNumberInProjectDetails(String taskName) {
        return findByXpath(String.format("(//*[contains(@class,'taskStatusName')]//*[@title='To Do']/following::*[@class='taskTitleEllipsis' and contains(text(),'%s')]/following::*[contains(@class,'taskLabels')]//span[@class='text-truncate'])[1]", taskName));
    }

    private BaseElementFacade getTaskCommentWithUser(String user, String comment) {
        return findByXpath(String.format("//*[@class='TaskCommentContent']//*[contains(text(),'%s')]/following::*[@class='taskContentComment']//p[contains(text(),'%s')]", user, comment));
    }
    ...
    private BaseElementFacade getTaskOrder(String number) {
        return findByXpath(
                String.format("(//*[@id='projectListApplication']//*[contains(@id,'taskView')]//*[contains(@class,'taskTitle')]//a)[%s]", number));
    }

    private BaseElementFacade getDisplayedLabel(String label, String times) {
        return findByXpath(
                String.format("//*[@class='nameGroup' and contains(text(),'%s')]//following::*[@class='amount-item' and contains(text(),'%s')][1]", label, times));
    }

    private BaseElementFacade getAddLabelToTask(String label) {
        return findByXpath(
                String.format("//*[contains(@class,'v-list')]//*[contains(@class,'v-chip v-chip--label')]//*[contains(@class,'v-chip__content') and contains(text(),'%s')]", label));
    }

    private BaseElementFacade getLabelInEditTaskDrawer(String label) {
        return findByXpath(
                String.format("//*[contains(@class,'v-chip__content')]//*[contains(@class,'pe-2') and contains(text(),'%s')]", label));
    }
    ...
    private BaseElementFacade getProjectCardDescription(String description) {
        return findByXpath(
                String.format("//*[@class='taskItemDescription largeDescriptionArea']//*[contains(text(),'%s')]", description));
    }
    ...
    private BaseElementFacade getRemoveLabelButton(String label) {
        return findByXpath(
                String.format("//*[contains(@class,'v-chip__content')]//*[contains(@class,'pr-2') and contains(text(),'%s')]/following::button[2]", label));
    }

    private BaseElementFacade getRemoveLabelTaskButton(String label) {
        return findByXpath(
                String.format("//*[contains(@class,'v-chip__content')]//*[contains(@class,'pe-2') and contains(text(),'%s')]/following::button[1]", label));
    }

    private BaseElementFacade getTaskTitleInTasksTab(String taskName) {
        return findByXpath(
                String.format("//*[contains(@class,'v-application tasksList')]//*[contains(@class,'taskTitle pe-14')]/a[contains(text(),'%s')]", taskName));
    }
    ...
    public void addSixLabelToProject(String label1, String label2, String label3, String label4, String label5, String label6) {
        labelTask.sendKeys(label1 + Keys.ENTER + label2 + Keys.ENTER + label3 + Keys.ENTER + label4 + Keys.ENTER + label5 + Keys.ENTER + label6 + Keys.ENTER);
    }
    ...
    Map<String, TextBoxElementFacade> ADD_TASK_MAPPING_CONTAINER_NAME_TO_BASEELEMENTFACADE_XPATH = new HashMap<String, TextBoxElementFacade>() {
        {
    ...
    public void attachDocument(String fileName)
        ...
        Thread.sleep(3000);
        WebElement elem = getDriver().findElement(By.xpath("//div[@class='multiUploadFilesSelector d-flex flex-column']//input[@name='file']"));
    ...
    public void checkFileDisplay(String fileName) {
        getFileName(fileName).isVisibleAfterWaiting();
    }
    ...
    public void openFileUploaded(String fileName) {
        getFileName(fileName).clickOnElement();
    }
    ...
    public void checkOpeningFileWithEditOnline(String titleDoc, String userName) throws InterruptedException {
        Thread.sleep(6000);
        getTitleDoc(titleDoc).isVisibleAfterWaiting();
        getUsername(userName).isVisibleAfterWaiting();
    ...
    public void detachAttachment() {
        detachIcon.waitUntilVisible();
        detachIcon.clickOnElement();
    }
    ...
    public void verifyAttachmentDisplay(String attachmentName) {
        getFileName(attachmentName).isNotVisibleAfterWaiting();
    }
    ...
    public void checkChangedFile(String changedFileName) {
        getChangedFileName(changedFileName).isVisibleAfterWaiting();
    }
    ...
    public void checkMovedFile(String movedFileName) {
        getMovedFile(movedFileName).isVisibleAfterWaiting();
    }
    ...
    private BaseElementFacade getTaskTitleDateFromWidget(String taskName) {
        return findByXpath(String.format("(//*[@id='TasksContainer']//div[@class='v-list-item__title' and text()='%s'])[1]", taskName));
    }
    ...
    @FindBy(xpath = "//*[@class='v-input__control']//i[@class='v-icon notranslate mdi mdi-flag-variant theme--light nonePriorityColor']")
    private BaseElementFacade taskPrioritySelector;

    private BaseElementFacade getTaskPriority(String taskPriority) {
        return findByXpath(
                String.format("//*[@class='taskPriority']//*[@class='v-select__selections']/div[contains(text(),'%s')]", taskPriority));
    }
    ...
    private BaseElementFacade getTaskStatus(String taskStatus) {
        return findByXpath(
                String.format("//*[@class='taskStatus']//*[contains(@class,'v-select__selection--comma') and contains(text(),'%s')]", taskStatus));
    }

    private BaseElementFacade selectTaskStatus(String taskStatus) {
        return findByXpath(
                String.format("//*[@role='listbox']//*[@class='v-list-item__title' and contains(text(),'%s')]", taskStatus));
    }
    ...
    private BaseElementFacade getSelectUserInDropDown(String firstUserName) {
        return findByXpath(String.format(
                "//div[contains(@class,'identitySuggestionMenuItemText') and contains(text(),'%s')]", firstUserName));
    }
    ...
    @FindBy(xpath = "((//div[@class='v-picker__actions v-card__actions']//div[contains(@class,'d-flex flex-wrap')])[02]//button)[03]")
    ...
    private BaseElementFacade getTaskNamePlanView(String taskName) {
        return findByXpath(String.format(
                "//*[@class='bar-group']//*[contains(text(),'%s')]", taskName));
    }
