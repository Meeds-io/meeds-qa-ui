...
public class SpaceHomePage extends GenericPage {
  ...
  private BaseElementFacade getArticleTitleAndSummaryNotClickable(String summary, String title) {
    return findByXpath(String.format("//*[contains(text(),'%s')]/preceding::*[contains(text(),'%s')]/preceding::*[@class='uiIconArchived'][1]",
                                     title,
                                     summary));
  }
  ...
  private BaseElementFacade getSharedFile(String fileName) {
    return findByXpath(String.format("//*[contains(@id,'PreviewAttachment')]//*[contains(@class,'v-card__text activity-attachment-title')]//*[contains(text(),'%s')]",
                                     fileName));
  }
  ...
  private BaseElementFacade getFileExtension(String fileExtension) {
    return findByXpath(String.format("//*[@id='previewPopup']/following::*[@class='ellipsis' and contains(text(),'%s')]",
                                     fileExtension));
  }
  ...
  private BaseElementFacade articleActivityStreamThreeDotsButton(String id) {
    return findByXpath(String.format("//*[contains(@id,'dropDownEditActivity%s')]//*[@class='uiIconActivityAction uiIconLightGray']",
                                     id));
  }
  ...
  private BaseElementFacade articleActivityStreamUnpinArticleAlertMessage(String id) {
    return findByXpath(String.format("//*[contains(@id,'alertMessagePin')]//*[@id='messagePinBody%s' and contains(text(),'The article was successfully unpinned')]",
                                     id));
  }
  ...
  private BaseElementFacade ELEMENT_FILE_PREVEIW(String file) {
    return findByXpath(String.format("//*[@id='previewPopup']/following::*[@class='searchMatchExcerpt' and contains(text(),'%s')]",
                                     file));
  }
