...
public class ManageSpacesPage extends GenericPage {
	...
	private BaseElementFacade getAppCardNameDisplayed(String application) {
		return findByXpath(String.format("//*[contains(@title,'%s') and @class='text-truncate subtitle-1 px-1 pt-4 text-color SpaceApplicationCardTitle']", application));
	}

	private BaseElementFacade getAppCardNameDrawer(String application) {
		return findByXpath(String.format("(//*[contains(@title,'%s') and @class='text-truncate subtitle-1 px-1 pt-4 text-color SpaceApplicationCardTitle']/following::*[contains(@class,'mdi mdi-plus')])[1]", application));
	}
	...
	private BaseElementFacade spaceName(String spaceName) {
		return findByXpath(String.format("//*[@class='ps-2 align-self-center brandingContainer space']//*[contains(text(),'%s')]", spaceName));
	}
	...
	private BaseElementFacade ELEMENT_SPACE_TABS_TOP_BAR_ORDER(String order) {
		return findByXpath(String.format("//*[@class='v-application--wrap']//*[@class='v-slide-group__wrapper']//*[@tabindex][%s]", order));
	}
	...
	private BaseElementFacade ELEMENT_SPACE_DOCUMENTS_TAB_TOP_BAR(String space) {
		return findByXpath(String.format("//*[@id='MiddleToolBar']//*[contains(@href,'%s/documents')]", space));
	}
	...
	private BaseElementFacade ELEMENT_SPACE_CALENDAR_TAB_TOP_BAR(String space) {
		return findByXpath(String.format("//*[@id='MiddleToolBar']//*[contains(@href,'%s/agenda')]", space));
	}
	...
	public void checkThatSpaceTabsAreDisplayedInOrder(String space) {
		...
		Assert.assertTrue(ELEMENT_SPACE_TABS_TOP_BAR_ORDER("2").getAttribute("href")
				.contains(ELEMENT_SPACE_DOCUMENTS_TAB_TOP_BAR(space.toLowerCase()).getAttribute("href")));

		Assert.assertTrue(ELEMENT_SPACE_TABS_TOP_BAR_ORDER("3").getAttribute("href")
				.contains(ELEMENT_SPACE_CALENDAR_TAB_TOP_BAR(space.toLowerCase()).getAttribute("href")));

		Assert.assertTrue(ELEMENT_SPACE_TABS_TOP_BAR_ORDER("4").getAttribute("href")
				.contains(ELEMENT_SPACE_MEMBERS_TAB_TOP_BAR(space.toLowerCase()).getAttribute("href")));

		Assert.assertTrue(ELEMENT_SPACE_TABS_TOP_BAR_ORDER("5").getAttribute("href")
	...
	private BaseElementFacade ELEMENT_SPACE_PAGE (String space) {
		return findByXpath(String.format("//*[@class='pl-2 align-self-center brandingContainer space']//*[contains(text(),'%s')]", space));
	}
	...
	public boolean isSpacePageOpened(String space) {
		return ELEMENT_SPACE_PAGE(space).isVisibleAfterWaiting();
	}
	...
	public void checkDisplayOfOtherSpaces() { SpaceCardN21.isVisibleAfterWaiting(); }

	public void clickOnSpaceSettingsTab() { spaceSettingsTab.clickOnElement(); }

	public void checkGeneralSpaceSettings() {editIconOfGeneralSpaceSettings.isVisibleAfterWaiting(); }

	public void checkApplicationsSpaceSettings() {arrowIconOfApplicationsSpaceSettings.isVisibleAfterWaiting(); }

	public void clickOnGeneralSpaceSettings() {editIconOfGeneralSpaceSettings.clickOnElement(); }

	public void checkAvatarSection() {avatarSection.isVisibleAfterWaiting(); }

	public void checkNameSpaceSection() {nameSpaceSection.isVisibleAfterWaiting(); }

	public void checkDescriptionSpaceSection() {descriptionSpaceSection.isVisibleAfterWaiting(); }

	public void checkSpaceTemplateSection() {spaceTemplateSection.isVisibleAfterWaiting(); }
	...
	public void checkRegistrationSection() {registrationSection.isVisibleAfterWaiting(); }

	public void checkCancelButton() {cancelButton.isVisibleAfterWaiting(); }

	public void checkUpdateButton() {spaceAppInstallerDrawer.isVisibleAfterWaiting(); }

	public void clickOnArrowIconAppSpaceSettings() {arrowIconAppSpaceSettings.clickOnElement(); }

	public void spaceAppSettingsIsOpened() {spaceAppSettingsPage.isVisibleAfterWaiting(); }

	public void appCardIsDisplayed() {appCard.isVisibleAfterWaiting(); }

	public void plusButtonIsDisplayed() {plusButtonAppSpaceSettings.isVisibleAfterWaiting(); }

	public void clickOn3dotsAppCard() {button3dotAppCard.clickOnElement(); }

	public void removeAppButtonIsDisplayed() {removeAppButton.isVisibleAfterWaiting(); }

	public void moveBeforeAppButtonIsDisplayed() {moveBeforeAppButton.isVisibleAfterWaiting(); }

	public void moveAfterAppButtonIsDisplayed() {moveAfterAppButton.isVisibleAfterWaiting(); }

	public void clickOnPlusButton() {plusButtonAppSpaceSettings.clickOnElement(); }

	public void checkSpaceAppInstallerDrawerIsDisplayed() {spaceAppInstallerDrawer.clickOnElement(); }

	public void checkApplicationsAreDisplayed() {addAppButton.isVisibleAfterWaiting(); }

	public void clickToAddApp(String application) {getAppCardNameDrawer(application).clickOnElement();}

	public void checkThatAppIsAdded(String application) {getAppCardNameDisplayed(application).isVisibleAfterWaiting();}
	...
	public void goToTasksTab() { spaceTasksTab.clickOnElement(); }
